            ...
            if(isset($Recordset[0])){
                ...
                foreach($Recordset as $keyisi=>$isi){
                    ...
                    */
                    ...
                    <button class=\"d-sm-inline-block btn btn-sm btn-info shadow-sm kotak\" style=\"width:100%;margin-top:5px;\" id=\"berkasSurat$keyisi\" data-toggle=\"modal\" data-target=\"#modal_baca_surat_new\"><i class='fas fa-folder-open fa-sm text-white-100'></i> <br>Foto</button>
                    </td>";
                    ...
                    echo "
                        $(\"#berkasSurat$keyisi\").click(function(){
							...
							function(data,status){
                                ...
                                loading1.fadeOut();
                                ";
                                if($foto[sizeof($foto)-1]=='pdf'||$foto[sizeof($foto)-1]=='png'||$foto[sizeof($foto)-1]=='jpg'||$foto[sizeof($foto)-1]=='html'||$foto[sizeof($foto)-1]=='htm'||$foto[sizeof($foto)-1]=='bmp'||$foto[sizeof($foto)-1]=='gif'||$foto[sizeof($foto)-1]=='mp4'||$foto[sizeof($foto)-1]=='mp3'||$foto[sizeof($foto)-1]=='vid'||$foto[sizeof($foto)-1]=='wav') echo "            tampilkan1.html(data);";
                    echo "		});
                        });
